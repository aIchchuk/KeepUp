...
const ProjectDetail = () => {
    ...
    return (
        <div className="min-h-screen relative overflow-x-hidden">
            ...
            {/* Scrollable Content */}
            <div className="relative z-10 min-h-screen flex flex-col pt-[8vh]">
                <div className="max-w-7xl mx-auto px-8 w-full pb-20">
                    {/* Main Content Box */}
                    <div className="bg-white/95 backdrop-blur-xl rounded-[48px] shadow-[0_32px_80px_-16px_rgba(0,0,0,0.3)] border border-white/20 p-12 min-h-[600px]">
                        {/* Header Section */}
                        <div className="mb-12">
                            <div className="flex items-start justify-between gap-10">
                                ...
                                <div className="flex items-center gap-4">
                                    <button className="bg-white/90 backdrop-blur-md px-6 py-3 rounded-2xl text-xs font-bold text-gray-800 transition-all hover:bg-white shadow-lg border border-gray-100">
                                        Change Cover
                                    </button>
                                    <button
                        ...
                        <div className="space-y-12">
                            {items.length === 0 ? (
                                <div className="py-20 flex flex-col items-center justify-center text-center space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
                                    <div className="w-24 h-24 bg-gray-50 rounded-[32px] flex items-center justify-center text-4xl shadow-inner border border-gray-100/50">
                                        ✨
                                    </div>
                                    <div className="space-y-2">
                                        <h2 className="text-3xl font-bold text-gray-900 tracking-tight">Your canvas is empty</h2>
                                    ...
                                    <div className="flex gap-4 pt-4">
                                        <button
                                            onClick={() => openModal('task')}
                                            className="px-8 py-3.5 bg-indigo-600 text-white rounded-2xl font-bold hover:bg-indigo-700 transition-all shadow-xl shadow-indigo-100 flex items-center gap-2"
                                        >
                                            <span>+</span> Add Task
                                        </button>
                                        <button
                                            onClick={() => openModal('page')}
                                            className="px-8 py-3.5 bg-white text-gray-700 border border-gray-100 rounded-2xl font-bold hover:bg-gray-50 transition-all shadow-sm flex items-center gap-2"
                                        >
                                            <span>📄</span> New Page
                                        </button>
                                    </div>
                        ...
                        <div className={`fixed inset-y-0 right-0 w-[600px] bg-white z-[150] transform transition-transform duration-500 ease-out flex flex-col ${showEditModal ? 'translate-x-0 shadow-[-20px_0_50px_rgba(0,0,0,0.05)] border-l border-gray-100' : 'translate-x-full shadow-none border-none invisible pointer-events-none'}`}>
                            {selectedItem && (
                                <>
                                    {/* Drawer Header */}
